...
public class MenuPanel extends JPanel {
    ...
    //private ImageIcon logga = new ImageIcon("src/global/resources/smalllogga.PNG");
    private ImageIcon logga = new ImageIcon(getClass().getClassLoader().getResource("smalllogga.PNG"));
